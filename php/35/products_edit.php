                ...
                <div class="card-body">
                    ...
                    <form name="form1" onsubmit="sendData();return false;" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="products_forsale" name="products_forsale" value="<?= $row['products_forsale'] ?>">
                            <div class="form-text"></div>
                        </div>

                        <div class="mb-3">
                            <label for="products_onsale" class="form-label">是否有特價</label>
                            <input type="number" class="form-control" id="products_onsale" name="products_onsale" value="<?= $row['products_onsale'] ?>">
                            <div class="form-text"></div>
                        </div>
                        ...
                        <div class="mb-3">
                            <label for="products_categroies_sid" class="form-label">商品分類</label>
                            <select name="products_categroies_sid" id="products_categroies_sid">
                        ...
                        <div class="mb-3">
                            <label for="products_style_filter_sid" class="form-label">商品風格</label>
                            <select name="products_style_filter_sid" id="products_style_filter_sid">
                                <option value="">-- 請選擇 -- </option>
