...
$products_categroies_sid = $_POST['products_categroies_sid'] ?? '';
$products_pic_one = $_POST['products_pic_one'] ?? '';
$products_pic_multi = $_POST['products_pic_multi'] ?? '';
$products_style_filter_sid = $_POST['products_style_filter_sid'] ?? '';
...
$stmt->execute([
    ...
    $products_onsale,
    $products_stocks,
    $products_categroies_sid,
    $products_pic_one,
    $products_pic_multi,
    $products_style_filter_sid,
]);
