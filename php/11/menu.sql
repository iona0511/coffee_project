...
(1, '經典義式系列', 'b0d04075d4610e7f90232553405991b2.jpg', '咖啡拿鐵', 381.4, '70', '咖啡因含量:黃101-200mg/杯', '2022-06-10 00:00:00'),
...
(5, '經典義式系列', '2b09effc9b57ee1b1b99052bb3140813.jpg', '黑糖風味拿鐵', 375.2, '80', '咖啡因含量:黃101-200mg/杯', '2022-06-14 00:00:00'),
...
--
ALTER TABLE `menu`
  MODIFY `menu_sid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
COMMIT;
