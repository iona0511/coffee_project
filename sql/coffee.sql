...
(189, '精品咖啡', 'c92e70256fb8cf814daa982af0664bc9.jpg', '莊園級拿鐵 ', 267.7, '80', '咖啡因含量:紅201mg/杯', '2022-06-09 13:42:29'),
...
(195, '精品咖啡', '24eb56a8380290fe5247904031f60c33.jpg', '哈哈', 4545, '44', '4', '2022-06-09 14:37:46');
...
(1, '體驗拉花課程分享', '每次看到咖啡師的拉花作品，再看看咖啡師拉花的動作看似簡單，胃痛一直很想要體驗拉花，想不到自己實際操作一遍，操作起來還真的不簡單啊。', '帥氣a小明', 1001, 3, 2, 1, '2022-05-31 04:35:39', NULL, 0),
...
(2, '1653962417', '曼特寧咖啡(一包十入)', '精選曼特寧咖啡, 一包十入', '香濃甘苦的滋味，不帶酸味順口香醇。', 320, 1, 0, 3200, 2, 2),
...
(1, '', ''),
(2, 'manba_bean.jfif', 'bag-coffee2.jpg,drip-bag.jpg,manba_bean.jfif'),
...
--
ALTER TABLE `course`
  MODIFY `course_sid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;
...
--
ALTER TABLE `lastest_news`
  MODIFY `news_sid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `member`
--
ALTER TABLE `member`
  MODIFY `member_sid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1040;
...
--
ALTER TABLE `menu`
  MODIFY `menu_sid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=196;
...
--
ALTER TABLE `products`
  MODIFY `products_sid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `products_pic`
  MODIFY `products_pic_sid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
